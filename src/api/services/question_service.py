...
def get_random_question(topic: list[str] | None = None, min_intimacy: float | None = None, max_intimacy: float | None = None):
...
def get_random_questions(topic: list[str] | None = None, min_intimacy: float | None = None, max_intimacy: float | None = None, limit: int = 12):
